...
/**
 * This class encapsulates all of Kjaro's messages
 */
public class Messages {
    ...
    public static final Function<Integer, String> TASKLIST_MESSAGE = x -> "Here is your task list! You currently have "
                                    + x + " task(s)!";
    ...
    public static final Function<Integer, String> UNMARK_MESSAGE = x -> "I've marked task " + x
                                    + "as undone, you'll get it next time.";
